...
define(["jquery", "jquery-ui", 'color-picker'], function($) {
    ...
    function init( containerIDWithHash, _callback ) {
        ...
        $.get("charts/indicators/bop/bop_level.html" , function ( $html ) {
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            ...
                            require(["validation/validation"], function(validation) {
                                ...
                                if (!validation.validateNumericBetween($html.find(".bop_level_input_width_for_level").val(),
                                ...
                                if (callBackAfterOKPressed) {
                                    callBackAfterOKPressed([new Level(parseFloat($html.find(".bop_level_input_width_for_level").val()),
                                        ...
                                        $html.find("#bop_level_dashStyle").val())]);
                                }
