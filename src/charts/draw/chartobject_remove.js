...
define(['charts/draw/highcharts_custom/DrawingBase', "jquery", "datatables", 'charts/charts'], function(DrawingBase, $) {
    ...
    return {
        ...
        openDialog: function(containerIDWithHash) {
            ...
            var drawToolList = DrawingBase.listAllDrawTools(containerIDWithHash);
