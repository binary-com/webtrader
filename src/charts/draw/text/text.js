...
define(["jquery", "common/util", 'jquery-ui', 'color-picker', 'ddslick'], function($) {  
    ...
    var dialogOptions = {
        ...
        buttons: [{
            ...
            click: function() {
                ...
                defaultText = $html.find("#text_string").val();
    ...
    function initializeDialog(chartID, callback) {
        ...
        require(['css!charts/draw/text/text.css']);

        require(['text!charts/draw/text/text.html'], function($html) {
