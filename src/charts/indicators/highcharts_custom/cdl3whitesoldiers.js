...
define(['indicator_base', 'highstock'], function (indicatorBase) {
	...
	function calculateIndicatorValue(data, index) {
		...
		var isBullishContinuation = isCandleThree_Bullish  && (Math.abs(candleThree_Close-candleThree_Open) > candleMediumHeight)
				                	&& isCandleTwo_Bullish && (Math.abs(candleTwo_Close - candleTwo_Open) > candleMediumHeight) && (candleTwo_Open > candleThree_Open && candleTwo_Open <= candleThree_Close && candleTwo_Close > candleThree_Close)
					                && isCandleOne_Bullish && (Math.abs(candleOne_Close - candleOne_Open) > candleMediumHeight) && (candleOne_Open > candleTwo_Open && candleOne_Open <= candleTwo_Close && candleOne_Close > candleTwo_Close);
