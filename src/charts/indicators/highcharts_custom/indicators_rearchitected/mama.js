...
MAMA = function (data, options, indicators) {
    ...
    for (var index = 0; index < data.length; index++) {
        var mama = CalculateMAMAValue.call(this, data, index);
        this.indicatorData.push({ time: data[index].time, value: mama });
        this.priceData.push(data[index]);
    }
};

CalculateMAMAValue = function (data, index) {
    /* MAMA :
    /*FORMULA
...
MAMA.prototype.addPoint = function (data) {
    ...
    var mama = CalculateMAMAValue.call(this, this.priceData, this.priceData.length - 1);
...
MAMA.prototype.update = function (data) {
    ...
    var mama = CalculateMAMAValue.call(this, this.priceData, index);
