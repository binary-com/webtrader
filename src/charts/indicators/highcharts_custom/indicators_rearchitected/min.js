...
MIN = function (data, options, indicators) {
    ...
    for (var index = 0; index < data.length; index++) {
        if (index >= (this.options.period - 1)) {
            var min = CalculateMINValue.call(this, data, index);
...
CalculateMINValue = function (data, index) {
    /* MIN :
...
MIN.prototype.addPoint = function (data) {
    ...
    var min = CalculateMINValue.call(this, this.priceData, this.priceData.length - 1);
...
MIN.prototype.update = function (data) {
    ...
    var min = CalculateMINValue.call(this, this.priceData, index);
