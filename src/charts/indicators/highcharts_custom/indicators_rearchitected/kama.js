...
KAMA = function (data, options, indicators) {
    ...
    for (var index = 0; index < data.length; index++) {
        if (index > (this.options.period - 1)) {
            var kama = CalculateKAMAValue.call(this, data, index);
...
CalculateKAMAValue = function (data, index) {
...
KAMA.prototype.addPoint = function (data) {
    ...
    var kama = CalculateKAMAValue.call(this, this.priceData, this.priceData.length - 1);
...
KAMA.prototype.update = function (data) {
    ...
    var kama = CalculateKAMAValue.call(this, this.priceData, index);
