...
define(['indicator_base', 'highstock'], function (indicatorBase) {
    ...
    function calculateIndicatorValue(data, index) {
        ...
        var isBullishContinuation = isCandleThree_Bullish && (candleThreeBody > (candleTwoBody * 3)) //The first part of an Evening Star reversal pattern is a large bullish green candle.
                        ...
                        for (var index = 2 ; index < data.length; index++) {
                            ...
                            if (bull_bear.isBullishContinuation) {
                                cdleveningstarData.push({
                                    ...
                                    title: '<span style="color : blue">ES</span>',
                                    text: 'Evening Star : Bull'
                                });
                            };
                        };
