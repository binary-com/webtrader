                ...
                buttons: [
                    {
                        text: "OK",
                        click: function () {
                            if (!isNumericBetween($html.find(".ultosc_input_width_for_period").val(),
                                            parseInt($html.find(".ultosc_input_width_for_period").attr("min")),
                                            parseInt($html.find(".ultosc_input_width_for_period").attr("max")))) {
                                require(["jquery", "jquery-growl"], function ($) {
                                    $.growl.error({
                                        message: "Only numbers between " + $html.find(".ultosc_input_width_for_period").attr("min")
                                                + " to " + $html.find(".ultosc_input_width_for_period").attr("max")
                                                + " is allowed for " + $html.find(".ultosc_input_width_for_period").closest('tr').find('td:first').text() + "!"
                                    });
                                });
                                return;
                            }
