    ...
    function init(containerIDWithHash, _callback) {
        ...
        require(['text!charts/indicators/sum/sum.html'], function ($html) {
            ...
            $html.find('#sum_level_add').click(function () {
                require(["charts/indicators/sum/sum_level"], function (sum_level) {
                ...
                buttons: [
                    {
                        ...
                        click: function () {
                            ...
                            if (!_.inRange($html.find(".sum_input_width_for_period").val(),
                                            parseInt($html.find(".sum_input_width_for_period").attr("min")),
                                            parseInt($html.find(".sum_input_width_for_period").attr("max")))) {
                                require(["jquery", "jquery-growl"], function ($) {
                                    $.growl.error({
                                        message: "Only numbers between " + $html.find(".sum_input_width_for_period").attr("min")
