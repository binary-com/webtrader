...
define(["jquery", "jquery-ui", 'color-picker'], function($) {
    ...
    function init( containerIDWithHash, _callback ) {
        ...
        require(['text!charts/indicators/willr/willr_level.html'], function ( $html ) {
            ...
            $html.find("#willr_level_stroke").colorpicker({
                part:	{
                    map:		{ size: 128 },
                    bar:		{ size: 128 }
                },
                select:			function(event, color) {
                    $("#willr_level_stroke").css({
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            ...
                            require(["validation/validation"], function(validation) {
                                ...
                                if (!validation.validateNumericBetween($html.find(".willr_level_input_width_for_level").val(),
    ...
    return {
        ...
        open : function ( containerIDWithHash, _callback ) {
            ...
            if ($(".willr_level").length == 0)
            {
                init( containerIDWithHash, this.open );
                return;
            }

            $(".willr_level").dialog( "open" );
