...
define(["jquery", "common/rivetsExtra", "jquery-ui", 'color-picker'], function ($, rv) {
    ...
    function init(containerIDWithHash, _callback) {
        ...
        require(['text!charts/indicators/cdlgapsidesidewhite/cdlgapsidesidewhite.html', 'text!charts/indicators/indicators.json'], function ($html, data) {
            ...
            var current_indicator_data = data.cdlgapsidesidewhite;
            var state = {
