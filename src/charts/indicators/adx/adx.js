        ...
        require(['text!charts/indicators/adx/adx.html'], function ( $html ) {
            ...
            $('#adx_dashStyle').ddslick({
                ...
                onSelected: function (data) {
                    $('#adx_dashStyle .dd-selected-image').css('max-width', '85px');
                    selectedDashStyle = data.selectedData.value
                }
            });
            $('#adx_dashStyle .dd-option-image').css('max-width', '85px');
            ...
            $html.find('#adx_level_add').click(function () {
                require(["charts/indicators/adx/adx_level"], function(adx_level) {
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            ...
                            if (!isNumericBetween($html.find(".adx_input_width_for_period").val(),
