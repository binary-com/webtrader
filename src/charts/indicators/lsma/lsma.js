                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            ...
                            if (!isNumericBetween($html.find(".lsma_input_width_for_period").val(),
                                            parseInt($html.find(".lsma_input_width_for_period").attr("min")),
                                            parseInt($html.find(".lsma_input_width_for_period").attr("max"))))
                            {
                                require(["jquery", "jquery-growl"], function($) {
                                    $.growl.error({ message: "Only numbers between " + $html.find(".lsma_input_width_for_period").attr("min")
                                            + " to " + $html.find(".lsma_input_width_for_period").attr("max")
                                            + " is allowed for " + $html.find(".lsma_input_width_for_period").closest('tr').find('td:first').text() + "!" });
                                });
                                return;
                            }
