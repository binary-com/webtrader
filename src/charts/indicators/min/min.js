...
define(["jquery", "jquery-ui", 'color-picker', 'ddslick'], function ($) {
    ...
    function init(containerIDWithHash, _callback) {
        ...
        require(['text!charts/indicators/min/min.html', 'text!charts/indicators/indicators.json'], function ($html, data) {
            ...
            $html.find('.min-description').html(current_indicator_data.description);
            ...
            $('#min_dashStyle').ddslick({
                ...
                onSelected: function (data) {
                    $('#min_dashStyle .dd-selected-image').css('max-height','5px').css('max-width', '115px');
                    selectedDashStyle = data.selectedData.value
                }
            });
            $('#min_dashStyle .dd-option-image').css('max-height','5px').css('max-width', '115px');
