...
define(["jquery", "jquery-ui", 'color-picker', 'ddslick'], function($) {
    ...
    function init( containerIDWithHash, _callback ) {
        ...
        require(['text!charts/indicators/ao/ao.html', 'text!charts/indicators/indicators.json'], function ( $html, data ) {
            ...
            $html.find('.ao-description').html(current_indicator_data.description);
            ...
            $('#ao_dashStyle').ddslick({
                ...
                onSelected: function (data) {
                    $('#ao_dashStyle .dd-selected-image').css('max-height','5px').css('max-width', '115px');
                    selectedDashStyle = data.selectedData.value
                }
            });
            $('#ao_dashStyle .dd-option-image').css('max-height','5px').css('max-width', '115px');
