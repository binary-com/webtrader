...
const updateIndicative = (data, state) => {
  ...
  function updateState(contract, state) {
    ...
    state.proposal_open_contract.entry_tick = setSymbolDecimalPlace(contract.entry_tick, contract.underlying);
    ...
    state.proposal_open_contract.exit_tick = setSymbolDecimalPlace(contract.exit_tick, contract.underlying);
