...
define(["jquery", "jquery-ui", 'color-picker', 'ddslick'], function ($) {
    ...
    function init( containerIDWithHash, _callback ) {
        ...
        require(['text!charts/indicators/tema/tema.html', 'text!charts/indicators/indicators.json'], function ( $html, data ) {
            ...
            var current_indicator_data = data.tema;
            $html.attr('title', current_indicator_data.long_display_name);
            $html.find('.tema-description').html(current_indicator_data.description);
            ...
            $('#tema_dashStyle').ddslick({
                ...
                onSelected: function (data) {
                    $('#tema_dashStyle .dd-selected-image').css('max-height','5px').css('max-width', '115px');
                    selectedDashStyle = data.selectedData.value
                }
            });
            $('#tema_dashStyle .dd-option-image').css('max-height','5px').css('max-width', '115px');
